...
Shader::Shader(const GLchar* vertexPath, const GLchar* fragmentPath)
{
	...
	try
	{
		...
		std::stringstream vShaderStream, fShaderStream;//stringstream包含自sstream
		//读取文件内容到数据流
		vShaderStream << vShaderFile.rdbuf();//rdbuf无参数。返回调用者的流缓冲指针。
	...
	//将着色器代码由string转化为char*
	const char* vShaderCode = vertexCode.c_str();
	const char* fShaderCode = fragmentCode.c_str();//c_str()返回一个char*指针，指向字符串开头
