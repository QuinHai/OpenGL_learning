...
int main()
{
	...
	unsigned char *data = stbi_load("Resources\\Cube.png", &width, &height, &nrChannels, 0);
	if (data)
	{
	...
	// -------------------------------------------------------------------------------------------
	ourShader.use();
	glUniform1i(glGetUniformLocation(ourShader.shaderProgram, "myTexture1"), 0);
	glUniform1i(glGetUniformLocation(ourShader.shaderProgram, "myTexture2"), 1);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		unsigned int proLoc = glGetUniformLocation(ourShader.shaderProgram, "projection");
